<x-layout>
    <div class=" continer-fluid bg-dark d-flex justify-content-center p-5 ">
        <div class="row">
            <h1 class="bentornato display-1 text-white">
    ...
    <div class="container my-5">
        <div class="row justify-content-center">
            ...
            <form  class="d-flex" action="{{route('admin.storeCategory')}}" method="POST">
                ...
                <button type="submit" class="btn btn-secondary text-white">Aggiungi</button>
            </form>
            </div>
        </div>
    </div>
